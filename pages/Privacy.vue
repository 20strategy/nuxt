<template>
    <div class="columns policy">
    <div class="column">
      
 <!-- ********* LEGAL SECTION FROM SHOPIFY -->        
<h2 class="has-text-centered">Puppyous' Shipping Policy</h2>
<p>This Privacy Policy describes how puppyous.com (the “Site” or “we”) collects, uses, and discloses your Personal Information when you visit or make a purchase from the Site.</p>
...
<li><strong>Source of collection:</strong> Collected automatically when you access our Site using cookies, log files, web beacons, tags, or pixels <i>[facebook. Google. Bing. Pinterest]</i>.</li>
<li><strong>Disclosure for a business purpose:</strong> shared with our processor Shopify <i>[None]</i>.</li>
</ul>
...
<ul>
<li><strong>Examples of Personal Information collected:</strong> Name, phone number, email address</li>
...
<li><i>We use Facebook and Pinterest pixels to help us understand how our customers use the Site.</i></li>
</ul>
...
<ul>
<li><i>CATEGORIES OF INFORMATION SOLD: Pet supplies</i></li>
<li><i>INSTRUCTIONS ON HOW TO OPT-OUT OF SALE; email at bark@puppyous.com</i></li>
...
<h3>GDPR</h3>
<p>If you are a resident of the EEA, you have the right to access the Personal Information we hold about you, to port it to a new service, and to ask that your Personal Information be corrected, updated, or erased. If you would like to exercise these rights, please contact us through the contact information below <i>or at bark@puppyous.com</i></p>
...
<h3>CCPA</h3>
<p>If you are a resident of California, you have the right to access the Personal Information we hold about you (also known as the ‘Right to Know’), to port it to a new service, and to ask that your Personal Information be corrected, updated, or erased. If you would like to exercise these rights, please contact us through the contact information below <i>or email us bark@puppyous.com</i>.</p>
...
<h3>Contact</h3>
<p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at bark@puppyous.com or by mail using the details provided below:</p>
<p>ThinkingPen Inc, 612 N Arden Blvd , Los Angeles CA 90004, United States</p>
Last updated: <i>03/20./2021</i>
<p>If you are not satisfied with our response to your complaint, you have the right to lodge your complaint with the relevant data protection authority.  If you can email us, we will provide you with further information at bark@puppyous.com</p>
<!-- ********* LEGAL SECTION FROM SHOPIFY -->   
